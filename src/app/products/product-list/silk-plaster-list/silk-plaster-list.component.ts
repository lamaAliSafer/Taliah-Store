...
@Component({
  selector: 'app-silk-plaster-list',
  templateUrl: './silk-plaster-list.component.html',
  styleUrls: ['./silk-plaster-list.component.css'],

})
export class SilkPlasterListComponent implements OnInit {
  item2: Product;
  id: number;
